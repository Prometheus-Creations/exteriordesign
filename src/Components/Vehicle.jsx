...
function Vehicle({ isLogged, setIsLogged }){
    ...
    const fetchCars = async () => {
        try {
            ...
            const response = await axios.get('https://54.177.239.211:3000/inventory');
    ...
    const deleteCar = async (id) => {
        try {
            const response = await axios.delete(`https://54.177.239.211:3000/delete/${id}`, {
                headers: {
    ...
    const editCar = async (id) => {
        try {
            const response = await axios.get(`https://54.177.239.211:3000/inventory/${id}`, {
                headers: {
                    'Content-Type': 'application/json',
                }
            });
